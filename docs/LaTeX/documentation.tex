...
In recent years, the rapid growth of mobile devices and wireless networks has led to a dramatic increase in the demand for efficient and low-latency computational services. Traditional cloud computing architectures, while powerful, often suffer from latency issues due to the physical distance between end-users and centralized data centers. To address these challenges, \textit{edge computing} has emerged as a promising paradigm by decentralizing computational resources closer to the users, significantly reducing latency and improving service quality.\\\\
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \]
        \item \textbf{Lognormal distribution:} \texttt{x} and \texttt{y} follow a lognormal distribution with parameters as defined in \autoref{factors}.
    \end{itemize}
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{avg_ql_2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{avg_rt_2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{avg_ql_3.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{avg_rt_3.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{avg_rt_a.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{avg_rt_b.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{users_vary.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{lambda_vary.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{size_vary.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1\textwidth]{warmup_analysis.png}
